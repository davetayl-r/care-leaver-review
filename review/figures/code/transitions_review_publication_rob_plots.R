...
raw_rob_location <- "./review/figures/plot_data/risk_of_bias_data.xlsx"
...
ggsave(
  file = "./review/figures/output/transitions_review_summary_rob_plot.png",
...
ggsave(
  file = "./review/figures/output/transitions_review_traffic_light_plot.png",
