---
title: "Supplementary material for a systematic review and meta-analysis of policies and interventions that improve health, psychosocial and economic outcomes for young people leaving the out-of-home care system"
author: |
  David J. A. Taylor
  [<img src="https://info.orcid.org/wp-content/uploads/2019/11/orcid_16x16.png" alt="ORCID icon" width="16" height="16">](https://orcid.org/0000-0001-8801-7488)
date: "September 2023"
output: 
  bookdown::html_document2:
    toc: true
    toc_float: true
bibliography: review_supplementary_material_references.bib 
...
The analysis code is available in a [GitHub repository](https://github.com/davetayl-r/transitions-review).

# List of excluded studies

```{r tables-excluded-studies, echo=FALSE}

## READ DATA

excluded_studies_file_location <- "./supplementary-material/inputs/excluded_studies.xlsx"
...
excluded_studies %>%
  ...
  kable(
    caption = 'Select list of excluded studies'
  ) %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
```
...
To be enrolled in the ICare2CHECK program, young people need to:
...
```{r tables-overview-electronic-databases, echo=FALSE}

## READ DATA

overview_info_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
overview_info %>%
  kable(
    caption = 'Details of electronic database searches') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-cochrane-search-results, echo=FALSE}

## READ DATA

cochrane_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
cochrane_search_results %>%
  kable(
    caption = 'Search strategy and results for Cochrane Controlled Register of Trials via Ovid') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-cinahl-search-results, echo=FALSE}

## READ DATA

cinahl_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
cinahl_search_results %>%
  kbl(
    caption = 'Search strategy and results for CINAHL via EBSCO') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-eric-search-results, echo=FALSE}

## READ DATA

eric_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
eric_search_results %>%
  kbl(
    caption = 'Search strategy and results for ERIC via Proquest') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-psycinfo-search-results, echo=FALSE}

## READ DATA

psycinfo_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
psycinfo_search_results %>%
  kbl(
    caption = 'Search strategy and results for PsycINFO via Ovid') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-medline-search-results, echo=FALSE}

## READ DATA

medline_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
medline_search_results %>%
  kbl(
    caption = 'Search strategy and results for MEDLINE via Ovid') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-embase-search-results, echo=FALSE}

## READ DATA

embase_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
embase_search_results %>%
  kbl(
    caption = 'Search strategy and results for EMBASE via Ovid') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-socio-abstracts-search-results, echo=FALSE}

## READ DATA

socio_abstracts_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
socio_abstracts_search_results %>%
  kbl(
    caption = 'Search strategy and results for Sociological Abstracts via Proquest') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-soc-services-abs-search-results, echo=FALSE}

## READ DATA

soc_services_abs_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
soc_services_abs_search_results %>%
  kbl(
    caption = 'Search strategy and results for Social Services Abstracts via Proquest') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-socindex-search-results, echo=FALSE}

## READ DATA

socindex_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
socindex_search_results %>%
  kbl(
    caption = 'Search strategy and results for SocIndex via EBSCO') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-nhs-econ-search-results, echo=FALSE}

## READ DATA

nhs_econ_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
nhs_econ_search_results %>%
  kbl(
    caption = 'Search strategy and results for NHS Economic Evaluation Database via Ovid') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-hta-search-results, echo=FALSE}

## READ DATA

hta_search_results_file_location <- "./supplementary-material/inputs/search_results.xlsx"
...
hta_search_results %>%
  kbl(
    caption = 'Search strategy and results for Health Technology Assessment via Ovid') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-grey-lit-overview, echo=FALSE}

## READ DATA

grey_lit_overview_file_location <- "./supplementary-material/inputs/grey_lit_search_results.xlsx"
...
grey_lit_overview %>%
  kbl(
    caption = 'Details of grey literature searches') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r tables-grey-lit-search-results, echo=FALSE}

## READ DATA

grey_lit_search_results_file_location <- "./supplementary-material/inputs/grey_lit_search_results.xlsx"
...
grey_lit_search_results %>%
  kbl(
    caption = 'Results of grey literature searches') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6")
...
```{r data-extration-homelessness, echo=FALSE}

options(knitr.kable.NA = '')

data_extraction_homelessness_data_location <- "./es-transformation/data/es_input.xlsx"
...
data_extraction_homelessness %>%
  ...
  kbl(
    caption = 'Quantitative data extraction: housing and homelessness outcomes') %>% 
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12
  ) %>%
...
```{r data-extration-health-wellbeing, echo=FALSE}

options(knitr.kable.NA = '')

data_extraction_health_data_location <- "./es-transformation/data/es_input.xlsx"
...
data_extraction_health %>%
  ...
  kbl(
    caption = 'Quantitative data extraction: health and wellbeing outcomes') %>% 
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12
  ) %>%
...
```{r data-extration-education, echo=FALSE}

options(knitr.kable.NA = '')

data_extraction_education_data_location <- "./es-transformation/data/es_input.xlsx"
...
data_extraction_education %>%
  ...
  kbl(
    caption = 'Quantitative data extraction: education outcomes') %>% 
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12
  ) %>%
...
```{r data-extration-economic, echo=FALSE}

options(knitr.kable.NA = '')

data_extraction_economic_data_location <- "./es-transformation/data/es_input.xlsx"
...
data_extraction_economic %>%
  ...
  kbl(
    caption = 'Quantitative data extraction: economic and employment outcomes') %>% 
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12
  ) %>%
...
```{r data-extration-criminal, echo=FALSE}

options(knitr.kable.NA = '')

data_extraction_criminal_data_location <- "./es-transformation/data/es_input.xlsx"
...
data_extraction_criminal %>%
  ...
  kbl(
    caption = 'Quantitative data extraction: criminal and delinquent behaviour outcomes') %>% 
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12
  ) %>%
...
```{r data-extration-risky, echo=FALSE}

options(knitr.kable.NA = '')

data_extraction_risky_data_location <- "./es-transformation/data/es_input.xlsx"
...
data_extraction_risky %>%
  ...
  kbl(
    caption = 'Quantitative data extraction: risky behaviour') %>% 
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12
  ) %>%
...
```{r data-extration-skills, echo=FALSE}

options(knitr.kable.NA = '')

data_extraction_life_skills_data_location <- "./es-transformation/data/es_input.xlsx"
...
data_extraction_life_skills %>%
  ...
  kbl(
    caption = 'Quantitative data extraction: life skills') %>% 
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12
  ) %>%
...
```{r pub-bias-ilp-homelessness, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on experiencing homelessness 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_homelessness_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_homelessness_meta.RDS"
...
```{r pub-bias-ilp-residential-moves, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on number of residential moves 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_residential_moves_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_residential_moves_meta.RDS"
...
```{r pub-bias-bf-qol, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of coaching and peer support programs on quality of life 16-24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

better_futures_qol_meta_data_location <- "./meta-analysis/output/meta/my_life_qol_meta.RDS"
...
```{r pub-bias-ilp-hs-ged, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on completion of high school or equivalent 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_hs_ged_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_hs_ged_meta.RDS"
...
```{r pub-bias-ilp-attended-university, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on commencement of university 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_university_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_attended_university_meta.RDS"
...
```{r pub-bias-bf-hs-ged, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of coaching and peer support programs on high school or equivalent completion 16-24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

better_futures_hs_ged_meta_data_location <- "./meta-analysis/output/meta/my_life_hs_ged_meta.RDS"
...
```{r pub-bias-bf-post-secondary-ed, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of coaching and peer support programs on commencement of post-secondary education 16-24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

better_futures_post_secondary_ed_meta_data_location <- "./meta-analysis/output/meta/my_life_post_secondary_ed_meta.RDS"
...
```{r pub-bias-ilp-earnings, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on earnings (in last 12 months) 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_earnings_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_earnings_meta.RDS"
...
```{r pub-bias-ilp-employed, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on current employment 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_employed_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_employment_meta.RDS"
...
```{r pub-bias-ilp-fin-assist, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on receipt of any financial assistance 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_fin_assist_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_fin_assist_meta.RDS"
...
```{r pub-bias-ilp-net-worth, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on net worth 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_net_worth_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_net_worth_meta.RDS"
...
```{r pub-bias-bf-employment, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of coaching and peer support programs on current employment 16-24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

better_futures_employment_meta_data_location <- "./meta-analysis/output/meta/my_life_employment_meta.RDS"
...
```{r pub-bias-ilp-delinquent-behaviours, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on delinquent behaviours 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_delinquent_behaviours_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_delinquent_behaviours_meta.RDS"
...
```{r pub-bias-ilp-pregnant, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on becoming pregnant (in last 12 months) 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_pregnant_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_pregnant_meta.RDS"
...
```{r pub-bias-ilp-prep-overall, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on overall preparedness 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_prep_overall_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_prep_overall_meta.RDS"
...
```{r pub-bias-ilp-prep-job, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on job-related preparedness 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_prep_job_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_prep_job_meta.RDS"
...
```{r pub-bias-ilp-fin-account, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on having any financial accounts 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_fin_account_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_fin_account_meta.RDS"
...
```{r pub-bias-ilp-social-sec, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on having a social security certificate 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_social_sec_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_social_sec_meta.RDS"
...
```{r pub-bias-ilp-birth-cert, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on having a birth certificate 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_birth_cert_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_birth_cert_meta.RDS"
...
```{r pub-bias-ilp-drivers-lic, echo=FALSE, fig.cap="Funnel plot for meta analysis of effect of independent living programs on having a driver's licence 24 months from baseline", fig.topcaption = TRUE, crop=TRUE}

knitr::knit_hooks$set(crop = knitr::hook_pdfcrop)

ilp_drivers_lic_meta_data_location <- "./meta-analysis/output/meta/independent_living_program_drivers_lic_meta.RDS"
...
ilp_eggers_results %>%
  kbl(
    caption = "Results of Egger's test of the intercept") %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-homelessness-ilp-summary, echo=FALSE}

## READ DATA

homelessness_ilp_grade_summary_file_location <- "./supplementary-material/inputs/grade_summary_results.xlsx"
...
homelessness_ilp_grade_summary %>%
  kbl(
    caption = 'Summary GRADE quality assessment for housing and homelessness outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
  collapse_rows(columns = 7, valign = "middle") %>%
  footnote(
    number = c("Downgraded two levels for risk of bias and one level for imprecision", "Downgraded two levels for risk of bias and one level for imprecision"))
```

```{r tables-grade-homelessness-ilp-detailed, echo=FALSE}

## READ DATA

homelessness_ilp_grade_detailed_file_location <- "./supplementary-material/inputs/grade_detailed_results.xlsx"
...
homelessness_ilp_grade_detailed %>%
  kbl(
    caption = 'Detailed GRADE quality assessment for housing and homelessness outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-health-coach-summary, echo=FALSE}

## READ DATA

health_coach_grade_summary_file_location <- "./supplementary-material/inputs/grade_summary_results.xlsx"
...
health_coach_grade_summary %>%
  kbl(
    caption = 'Summary GRADE quality assessment for health and wellbeing outcomes — Coaching and peer support programs') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
  collapse_rows(columns = 7, valign = "middle") %>%
  footnote(
    number = c("Downgraded two levels for risk of bias and one level for imprecision"))
```

```{r tables-grade-health-coach-detailed, echo=FALSE}

## READ DATA

health_coach_grade_detailed_file_location <- "./supplementary-material/inputs/grade_detailed_results.xlsx"
...
health_coach_grade_detailed %>%
  kbl(
    caption = 'Detailed GRADE quality assessment for health and wellbeing outcomes — Coaching and peer support programs') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-education-ilp-summary, echo=FALSE}

## READ DATA

education_ilp_grade_summary_file_location <- "./supplementary-material/inputs/grade_summary_results.xlsx"
...
education_ilp_grade_summary %>%
  kbl(
    caption = 'Summary GRADE quality assessment for education outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
  collapse_rows(columns = 7, valign = "middle") %>%
  footnote(
    number = c("Downgraded two levels for risk of bias and one level for imprecision", "Downgraded two levels for risk of bias, one level for imprecision and one level for inconsistency"))
```

```{r tables-grade-education-coach-summary, echo=FALSE}

## READ DATA

education_coach_grade_summary_file_location <- "./supplementary-material/inputs/grade_summary_results.xlsx"
...
education_coach_grade_summary %>%
  kbl(
    caption = 'Summary GRADE quality assessment for education outcomes — Coaching and Peer Support programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
  collapse_rows(columns = 7, valign = "middle") %>%
  footnote(
    number = c("Downgraded one level for risk of bias and two levels for imprecision", "Downgraded one level for risk of bias and two levels for imprecision"))
```

```{r tables-grade-education-ilp-detailed, echo=FALSE}

## READ DATA

education_grade_ilp_detailed_file_location <- "./supplementary-material/inputs/grade_detailed_results.xlsx"
...
education_grade_ilp_detailed %>%
  kbl(
    caption = 'Detailed GRADE quality assessment for education outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-education-coach-detailed, echo=FALSE}

## READ DATA

education_grade_coach_detailed_file_location <- "./supplementary-material/inputs/grade_detailed_results.xlsx"
...
education_grade_coach_detailed %>%
  kbl(
    caption = 'Detailed GRADE quality assessment for education outcomes — Coaching and Peer Suppport programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-economic-ilp-summary, echo=FALSE}

## READ DATA

economic_ilp_grade_summary_file_location <- "./supplementary-material/inputs/grade_summary_results.xlsx"
...
economic_ilp_grade_summary %>%
  kbl(
    caption = 'Summary GRADE quality assessment for economic or employment outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
  collapse_rows(columns = 7, valign = "middle") %>%
  footnote(
    number = c("Downgraded two levels for risk of bias and one level for imprecision", "Downgraded two levels for risk of bias and one level for imprecision", "Downgraded two levels for risk of bias, one level for imprecision and one level for inconsistency", "Downgraded two levels for risk of bias and one level for imprecision"))
```

```{r tables-grade-economic-coach-summary, echo=FALSE}

## READ DATA

economic_coach_grade_summary_file_location <- "./supplementary-material/inputs/grade_summary_results.xlsx"
...
economic_coach_grade_summary %>%
  kbl(
    caption = 'Summary GRADE quality assessment for economic or employment outcomes — Coaching and Peer Support programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
  collapse_rows(columns = 7, valign = "middle") %>%
  footnote(
    number = c("Downgraded one level for risk of bias and two levels for imprecision"))
```

```{r tables-grade-economic-ilp-detailed, echo=FALSE}

## READ DATA

economic_ilp_grade_detailed_file_location <- "./supplementary-material/inputs/grade_detailed_results.xlsx"
...
economic_ilp_grade_detailed %>%
  kbl(
    caption = 'Detailed GRADE quality assessment for economic or employment outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-economic-coach-detailed, echo=FALSE}

## READ DATA

economic_coach_grade_detailed_file_location <- "./supplementary-material/inputs/grade_detailed_results.xlsx"
...
economic_coach_grade_detailed %>%
  kbl(
    caption = 'Detailed GRADE quality assessment for economic or employment outcomes — Coaching and Peer Support programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-violence-ilp-summary, echo=FALSE}

## READ DATA

violence_ilp_grade_summary_file_location <- "./supplementary-material/inputs/grade_summary_results.xlsx"
...
violence_ilp_grade_summary %>%
  kbl(
    caption = 'Summary GRADE quality assessment for exposure to violence outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-violence-ilp-detailed, echo=FALSE}

## READ DATA

violence_ilp_grade_detailed_file_location <- "./supplementary-material/inputs/grade_detailed_results.xlsx"
...
violence_ilp_grade_detailed %>%
  kbl(
    caption = 'Detailed GRADE quality assessment for exposure to violence outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-risky-ilp-summary, echo=FALSE}

## READ DATA

risky_ilp_grade_summary_file_location <- "./supplementary-material/inputs/grade_summary_results.xlsx"
...
risky_ilp_grade_summary %>%
  kbl(
    caption = 'Summary GRADE quality assessment for risky behaviour outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-risky-ilp-detailed, echo=FALSE}

## READ DATA

risky_ilp_grade_detailed_file_location <- "./supplementary-material/inputs/grade_detailed_results.xlsx"
...
risky_ilp_grade_detailed %>%
  kbl(
    caption = 'Detailed GRADE quality assessment for risky behaviour outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-skills-ilp-summary, echo=FALSE}

## READ DATA

skills_ilp_grade_summary_file_location <- "./supplementary-material/inputs/grade_summary_results.xlsx"
...
skills_ilp_grade_summary %>%
  kbl(
    caption = 'Summary GRADE quality assessment for Life Skills outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
```{r tables-grade-skills-ilp-detailed, echo=FALSE}

## READ DATA

skills_ilp_grade_detailed_file_location <- "./supplementary-material/inputs/grade_detailed_results.xlsx"
...
skills_ilp_grade_detailed %>%
  kbl(
    caption = 'Detailed GRADE quality assessment for Life Skills outcomes — Independent Living Programmes') %>%
  kable_styling(
    bootstrap_options = c("hover", "condensed"),
    font_size = 12) %>%
  row_spec(0, color = "#FFFFFF", background = "#027EB6") %>%
...
prisma_file_location <- "./supplementary-material/inputs/prisma.xlsx"
